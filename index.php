  ...
  <main id="main" class="main">
                    ...
                    foreach( $myposts as $post ):
                      ...
                      ?>
                        <div class="reviews-photos__block">
                          <img class="reviews-photos__photo lazy" src="#" data-src="<?php the_post_thumbnail_url() ?>" alt="<?php the_title() ?>">
                        </div>
    ...
    <section id="questions" class="questions">
      <div class="questions__row">
        <div class="container">
          <h2 class="section-title questions__title"><?php the_field('works_default_title') ?> <b class="marker"><?php the_field('works_bold_title') ?></b></h2>
